...
REM Optimizacion Windows 10 - Strength Tweaks
...
Reg.exe add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\ApplicationManagement\AllowGameDVR" /v "EnableCfg" /t REG_DWORD /d "0" /f
